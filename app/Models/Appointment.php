...
class Appointment extends Model
{
    ...
    protected $fillable = [
        'stylist_id', 'customer_id', 'booking_id', 'portfolio_id',
        'amount', 'duration', 'extra', 'appointment_code', 'completion_code',
        'status', 'appointment_date', 'appointment_time', 'stylist_note',
        'service_notes', 'completed_at'
    ];
