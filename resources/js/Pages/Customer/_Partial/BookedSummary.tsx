...
const BookedSummary = ({
    ...
    }, [portfolio.id, getStepFromStatus, appointment_id, setAppointmentData]);
    useEffect(() => {
    ...
    }, [step, setExtra, appointmentData, setSelectedTime, setSelectedDate]);
    ...
    const handleBookingClick = () => {
        if (step === 1 || step === 7) {
            router.visit(route('customer.appointment.book', portfolio.id));
        }
    };
            ...
            <div className="space-y-2.5 md:space-y-4">
                ...
                {(step === 1 || step === 7) && (
                    <CustomButton
                        ...
                        disabled={isLoading}
                    >
                        {isLoading ? 'Processing...' : 'Book Again'}
                    </CustomButton>
                )}
