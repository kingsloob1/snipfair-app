    ...
    return (
        <AuthLayout className="w-full max-w-96 p-5 md:p-8">
                ...
                <div className="relative mb-6 flex gap-3.5 rounded-2xl bg-success-50 p-3 pr-5 shadow-lg">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <p className="font-inter text-sm text-success-normal">
                            ...
                            <b>
                                {user ? (user.email as string) : 'your email'}
                            </b>
            ...
            <div className="mb-4 text-center text-sm text-sf-primary-paragraph">
                Please input the code that was sent to your mobile phone or
                email address.
            </div>
            ...
            <Success
                ...
                description='You have successfully verified your account! Click on "Go to Dashboard" to access your profile.'
                canClose={false}
            />
        </AuthLayout>
    );
