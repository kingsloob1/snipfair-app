...
const DepositRequestModal: React.FC<DepositRequestModalProps> = ({
    ...
    const handleApprove = async () => {
        ...
        try {
            router.post(
                route('admin.deposits.approve', request.id),
                {},
                {
                    onSuccess: () => {
                        onClose();
                    ...
                    onError: (errors) => {
                        console.error('Error approving deposit:', errors);
                    },
                    onFinish: () => {
    ...
    const handleReject = async () => {
        ...
        try {
            router.post(
                route('admin.deposits.reject', request.id),
                {},
                {
                    onSuccess: () => {
                        onClose();
                    ...
                    onError: (errors) => {
                        console.error('Error declining deposit:', errors);
                    },
                    onFinish: () => {
                        setIsProcessing(false);
                    },
            ...
            <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-lg bg-white shadow-xl">
                <div className="p-6">
                    ...
                    {request.status === 'pending' &&
                        request.payment_method !== 'Payfast' && (
                    ...
                    {(request.status !== 'pending' ||
                        ...
                        <div className="rounded-lg bg-gray-50 p-4 text-center">
                            <p className="text-sm text-gray-600">
                                {request.payment_method === 'Payfast'
                                    ? 'This request is being managed automatically by Payfast API'
