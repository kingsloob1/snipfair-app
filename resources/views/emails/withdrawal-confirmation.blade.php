...
@section('content')
    <div class="greeting">
        Great news, {{ $stylist->name }}! 💰
    </div>

    <div class="content-section">
        <p>Your withdrawal request has been successfully processed and the funds are on their way to your account!</p>
    </div>
        ...
        <table class="table">
            ...
            @if($withdrawal->fee)
                <tr>
                    ...
                    <td style="color: #ef4444;">-R{{ number_format($withdrawal->fee, 2) }}</td>
                </tr>
                <tr>
                    <th>Net Amount Transferred</th>
                    <td style="color: #10b981; font-weight: 600;">R{{ number_format($withdrawal->amount - $withdrawal->fee, 2) }}</td>
                </tr>
            @endif
            {{-- <tr>
                <th>Reference ID</th>
    ...
    <div class="content-section">
        ...
        <ul style="margin: 1rem 0; padding-left: 1.5rem; color: #4b5563;">
            ...
            <li>Contact support if you don't receive funds within the expected timeframe</li>
        </ul>
    </div>
